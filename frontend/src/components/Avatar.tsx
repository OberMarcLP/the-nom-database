...
export function Avatar({ src, alt, size = 'md', fallbackText, className = '' }: AvatarProps) {
  ...
  return (
    <div
      className={`${sizeClass} rounded-full overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 text-white font-semibold ${className}`}
    >
      {src ? (
        <img
          src={src}
