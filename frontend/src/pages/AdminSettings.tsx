...
import { api, Category, FoodType, getCategories, getFoodTypes, createCategory, updateCategory, deleteCategory, createFoodType, updateFoodType, deleteFoodType } from '../services/api';
import { Settings, Database, Key, Globe, Mail, Save, Tag, Utensils, Plus, Edit2, Trash2, X } from 'lucide-react';
